...
echo "Dan Sesudah Memasukkan Password Akan Dimintai Memasukkan Kode, Dengan Awal Format: mysql>"
echo "Dan Silahkan Kalian Salin Mantra Ini, Dan Isi Ke Format mysql>"
echo "Mantra: CREATE DATABASE IF NOT EXISTS OCSPANEL;EXIT;"
echo "Harap Isi Dengan Benar Ya...."
read -p "Silahkan Tekan ENTER Jika Sudah Memahami Perintah Diatas"
mysql -u root -p
...
echo "Bagian DATABASE Isi Seperti Ini: "
